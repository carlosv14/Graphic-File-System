...
# Template: app
# Command: C:\Qt\5.3\mingw482_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile Proyecto2.pro
#############################################################################
...
Makefile: Proyecto2.pro C:/Qt/5.3/mingw482_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.3/mingw482_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug -o Makefile Proyecto2.pro
